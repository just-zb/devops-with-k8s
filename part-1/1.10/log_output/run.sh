...
DOCKER_IMAGE="devops-0.2"    # Docker 镜像名称
...
PUSH_IMAGE="zhubao/devops-0.2:latest"
echo "push image $PUSH_IMAGE"
docker tag devops-0.2:latest $PUSH_IMAGE
...
kubectl logs -l app=hashgenerator --all-containers=true
